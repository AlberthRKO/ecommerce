...
$(document).ready(function () {
    ...
    var customIconsHTML = function (params) {
        ...
        var editIconHTML = "<a href='#' data-toggle='modal' data-target='#editarMedidor'><i class= 'users-edit-icon text-primary feather icon-edit-1 mr-50'></i></a>"
        var deleteIconHTML = "<a href='#' data-toggle='modal' data-target='#eliminarMedidor'><i class= 'users-delete-icon text-danger feather icon-trash-2'></i></a>"
    ...
    if (document.getElementById("myGrid")) {
        ...
        agGrid
            .simpleHttpRequest({
                url: "/app-assets/data/medidor-list.json"
            })
            .then(function (data) {
