    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item active"><a href="blog"><i class="feather icon-file-text"></i><span
                        ...
                        <table class="table data-thumb-view">
                            ...
                            <tbody>
                                ...
                                @foreach( $blog as $blog )
                                    <tr>
                                        <td>{{ $blog->id }}</td>
                                        <td class="product-img"><img src="{{ asset('storage').'/'.$blog->image }}" alt="Img blog">
                                        </td>
                                        <td class="product-name">{{ $blog->name }}</td>
                                        <td class="product-category">{{ $blog->category == '1' ? 'Fotografía' : 'Noticia' }}</td>
                                        <td class="product-description">{{ $blog->description }}</td>
                                        <td class="product-action">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <a href="{{ url('/blog/'.$blog->id.'/editBlog')}}"><i class= 'text-primary feather icon-edit'></i></a>
